...
p=90
# (90% data used for training. Rest for validation)
...
# Loading logs about change of training and validation loss and accuracy over epochs

log = h5py.File('Training_logs_DMN_plus.h5','r+')
